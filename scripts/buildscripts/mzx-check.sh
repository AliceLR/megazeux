...
# SC2039 - Triggers because of "source" usage instead of ".". I doubt these
#          scripts will ever be run in something that doesn't support "source".
# SC2155 - Avoid masking return values for "export" doesn't matter because this
#          code never checks the return value of "export".
#
shellcheck \
 -e "SC2155" -e "SC2039" -e "SC1090" -e "SC1091" \
 -P "mzx-scripts/" \
