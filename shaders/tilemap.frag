...
void main( void )
{
    ...
    if(texture2D(baseMap, vec2(fract(tileinfo.z*7.96875) + (fract(Texcoord.x*256.0)*0.03125), (floor(tileinfo.z*7.9689) + fract(Texcoord.y) + tileinfo.w*2048.0) * 0.0546875)).x > 0.5)
    {
