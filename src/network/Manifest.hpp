...
UPDATER_LIBSPEC boolean manifest_compute_sha256(struct SHA256_ctx *ctx, FILE *f,
 unsigned long len);
UPDATER_LIBSPEC boolean manifest_entry_check_validity(struct manifest_entry *e,
 FILE *f);
