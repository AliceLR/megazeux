	...
	do {
		...
		switch(cmd) {
			...
			case 123://char edit
				...
				ec_change_char((unsigned char)(parse_param(&cmd_ptr[1],id)),temp);
				break;
			...
			case 216://Load char set ""
				ec_load_set(tr_msg(&cmd_ptr[2],id));
				break;
